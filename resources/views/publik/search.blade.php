...
@section('section')
    <!-- SECTION -->
    <div class="section" style="padding-top: 0;" id="section">
        <!-- container -->
        <div class="container">
            <!-- row -->
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        <h3 class="title"><i class="fa fa-circle" style="color: #06283D"></i> Pencarian : {{ request('q') }}</h3>
                    </div>
                </div>
                <!-- /section title -->
                ...
                <div class="col-md-12">
                    <div class="cards">
                        @foreach($services_search as $service)
                            <div class="card">
                                <div class="product category">
                                    <div class="product-img">
